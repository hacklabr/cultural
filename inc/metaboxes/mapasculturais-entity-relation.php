...
class MCEntityRelationMetabox {
    ...
    static function metabox(){
        ...
        <input type="text" name="<?php echo __CLASS__ ?>[mc-entity-relation]" value="<?php echo $metadata; ?>" style="width:100%" placeholder="<?php esc_attr_e('Informe aqui a url incluindo o http://', 'cultural'); ?>" /> <?php
    }
