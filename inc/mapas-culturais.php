...
function cultural_shortcode_event( $atts ) {
    ...
    <div class="event-container">
        ...
        <div class="event-data">
            ...
            <div class="event__venue"><strong>Local:</strong> Biblioteca Pública Marcos Rey</div>
            <div class="event__occurrance">13 de Outubro de 2014 às 14:00</div>
            <div class="event__classification"><strong>Classificação:</strong> Livre</div>
            <div class="event__price"><strong>Preço:</strong> Grátis</div>
