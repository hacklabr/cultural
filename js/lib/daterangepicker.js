  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                '<span class="pull-right js-cancel" style="cursor:pointer"><i class="fa fa-times"></i></span>' +
        ...
        this.container.find('.calendar')
            ...
            //.on('change.daterangepicker', $.proxy(this.updateInput, this));

        this.container.find('.js-cancel').on('click', $.proxy(this.clickCancel, this));
