...
// SUBSTITUA  Link pelo slug do metabox
...
class LinkMetabox {
    ...
    static function metabox(){
        ...
        ?> <input type="text" name="<?php echo __CLASS__ ?>[link]" value="<?php echo $metadata['link'][0]; ?>" style="width:100%" placeholder="Informe aqui a url incluindo o http://"/> <?php
    }
