...
function theme_options_menu() {
    ...
    $topLevelMenuLabel = 'Theme Options';
    $page_title = 'Opções';
    $menu_title = 'Opções';
...
function theme_options_page_callback_function() {
    ...
    <?php //////////// Edite a partir daqui //////////  ?>
                ...
                <div class="span-6 last">
                    ...
                    <label for="wellcome_title"><strong><?php _e("Facebook", "cultural"); ?></strong></label><br/>
                    ...
                    <br/><br/>
                    <label for="wellcome_title"><strong><?php _e("RSS", "cultural"); ?></strong></label><br/>
